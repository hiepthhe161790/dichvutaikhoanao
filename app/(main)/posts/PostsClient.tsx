...
export default function PostsClient({
  ...
  // Trigger refetch when page or category changes
  useEffect(() => {
    // Skip fetching on the very first mount since we already have initial server data
  ...
  // Trigger refetch when search query gets cleared
  useEffect(() => {
    if (searchQuery === "") {
      fetchPosts();
    }
