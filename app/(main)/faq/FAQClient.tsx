...
export default function FAQClient({ initialFaqData }: FAQClientProps) {
  ...
  const filteredFaqData = Object.keys(initialFaqData).reduce((acc, category) => {
    const filteredItems = initialFaqData[category].filter(
      (item) =>
